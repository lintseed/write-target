	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){
			...
			foreach($skins as $skin){
				...
				$style .= 'color: ' . $skin['button-text'] . '; border-color: ' . $skin['button-background'] . ';  }' . "\r\n";
				$styel .= '#class# .gdlr-button.without-border, input[type="button"], input[type="submit"]{ background-color: ' . $skin['button-background'] . '; }';
									...
									'options' => array(
										'header-style' => array(
											...
											'options' => array(
												...
												'style-2 gdlr-centered'=> __('Header Style 2', 'gdlr_translate'),
											),
											'default' => 'style-2 gdlr-centered',
											'description' => __('For header style 1 : please make sure that your logo height + logo margin is lessen than 67px','gdlr_translate')
										),
										'logo-alignment' => array(
											'title' => __('Logo Alignment', 'gdlr_translate'),
											'type' => 'combobox',
											'options' => array(
											...
											'default' => 'center',
											'wrapper-class' => 'header-style-wrapper style-2 gdlr-centered-wrapper'
										),
										'menu-alignment' => array(
											...
											'default' => 'center',
											'data-type' => 'text',
											'selector' => '.gdlr-navigation-wrapper .gdlr-navigation-container{ text-align: #gdlr#; }',
											'wrapper-class' => 'header-style-wrapper style-2 gdlr-centered-wrapper'
										),										
							...
							'options' => array(
								...
								'skin-settings' => array(
									...
									'options' => array(
											...
											'options' => array(
												...
												'button-background'=>__('Button Background/Border Color', 'gdlr_translate'),
											)
										),	
									)
								),							
								...
								'top-bar-color' => array(
									...
									'options' => array(
										'top-bar-bottom-border-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.top-navigation-wrapper, .gdlr-nav-search-form-button-wrapper{ border-color: #gdlr#; }'
										),							
								...
								'body-color' => array(
									...
									'options' => array(
										...
										'item-title-icon' => array(
											'title' => __('Item Title Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5be3b',
											'selector'=> '.gdlr-item-title-wrapper.pos-icon .gdlr-item-title-icon{ color: #gdlr#; }'
										),	
										'item-title-icon-background' => array(
											'title' => __('Item Title Icon Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#393939',
											'selector'=> '.gdlr-item-title-wrapper.pos-icon .gdlr-item-title-icon{ background-color: #gdlr#; }'
										),											
										'item-title-line' => array(
											'title' => __('Item Title Line', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#333333',
											'selector'=> '.gdlr-item-title-gimmick{ background-color: #gdlr#; }'
										),	
									...
									'options' => array(
										...
										'button-border-color' => array(
											...
											'selector'=> '.gdlr-button{ border-color: #gdlr#; }' .
												'.gdlr-button.without-border, input[type="button"], input[type="submit"]{ background-color: #gdlr#; }'
										),										
										...
										'feature-media-icon-color' => array(
											'title' => __('Column Service Icon Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-feature-media-item .feature-media-icon{ color: #gdlr#; }'
										),										
										'feature-media-icon-background-color' => array(
											'title' => __('Column Service Icon Background (Style 2) Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#3d3d3d',
											'selector'=> '.gdlr-feature-media-item .feature-media-icon{ background-color: #gdlr#; }'
										),
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-category-info-color' => array(
											'title' => __('Blog Category Info Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5be3b',
											'selector'=> '.gdlr-blog-grid .blog-category a, .gdlr-blog-grid .blog-category i, ' . 
												'.gdlr-blog-medium .blog-category a, .gdlr-blog-medium .blog-category i{ color: #gdlr#; }',
											'description'=> __('For blog medium and blog grid style','gdlr_translate')
										),
								...
								'portfolio-color' => array(
									...
									'options' => array(
										'portfolio-filter-button-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#f5be3b',
											'selector'=> '.portfolio-item-filter a{ background-color: #gdlr#; border-color: #gdlr# } ' .
												'.portfolio-item-filter a:hover, .portfolio-item-filter a.active{ color: #gdlr#; }'
										),					
										'portfolio-filter-button-text' => array(
											...
											'selector'=> '.portfolio-item-filter a{ color: #gdlr#; }' .
												'.portfolio-item-filter a:hover, .portfolio-item-filter a.active{ background-color: #gdlr#; } '
										),	
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'slider-outer-navigation-icon' => array(
											...
											'type' => 'colorpicker',
											'default' => '#d1d1d1',
											'selector'=> '.gdlr-item-title .icon-quote-left,  .gdlr-item-title .gdlr-flex-prev, ' . 
												'.gdlr-item-title .gdlr-flex-next{ color: #gdlr#; }',
