	...
	*/
	...
	if( !function_exists('gdlr_print_portfolio_item') ){
		function gdlr_print_portfolio_item( $settings = array() ){
			...
			$settings['portfolio-title-link'] = !empty($settings['portfolio-title-link'])? $settings['portfolio-title-link']: 'single';
			if( $settings['portfolio-filter'] == 'enable' ){
			
				// ajax infomation
				$ret .= '<div class="gdlr-ajax-info" data-num-fetch="' . $args['posts_per_page'] . '" ';
				$ret .= 'data-orderby="' . $args['orderby'] . '" data-order="' . $args['order'] . '" data-title="' . $settings['portfolio-title-link'] . '" ';
			...
			$no_space .= ' gdlr-portfolio-link-' . $settings['portfolio-title-link'];
